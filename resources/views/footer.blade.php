    ...
    <div class="container text-center text-md-left">
        <div class="row text-center text-md-left mt-3 pb-3">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p>
                    <a href="#" class="link-secondary" >Your Account</a>
                </p>
                <p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p class="text-white-50 d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door-fill mr-2" viewBox="0 0 16 16">
        ...
        <div class="row d-flex align-items-center">
            <div class="col-md-7 col-lg-8">
                <p class="text-center text-md-left text-white-50">© 2020 Copyright:
                    <a href="https://mdbootstrap.com/">
                        <strong > Nombre Empresa.com</strong>
                    </a>
                </p>
            </div>
